 ...
 * DiscoveryRoutingEngine, UserPreferencesRepository and Application context.
 */
class MapViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(MapViewModel::class.java)) {
            return MapViewModel(segmentRepository, geocodingService, discoveryRoutingEngine, userPreferences, application) as T
        }
